...
const Index = () => {
  const processSteps = [
    {
      ...
      description: "Получение эякулята производится мануальным методом в стерильных условиях ветеринарной клиники или близких к стерильным полевых условиях. Материал собирается в предварительно подготовленную стерильную емкость.",
      icon: "TestTube",
  ...
  const statistics = [
    ...
    { value: "10-15 лет", label: "Срок хранения при соблюдении условий" },
